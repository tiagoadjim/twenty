...
import { SyncStandardObjectsCommandModule } from 'src/engine/workspace-manager/workspace-migration/workspace-migration-runner/commands/sync-standard-objects-command.module';
...
@Module({
  imports: [
    ...
    SyncStandardObjectsCommandModule,
  ],
  providers: [
